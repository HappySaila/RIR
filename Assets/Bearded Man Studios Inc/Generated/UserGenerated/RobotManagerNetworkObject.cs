...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class RobotManagerNetworkObject : NetworkObject
	{
		...
		public RobotManagerNetworkObject() : base() { Initialize(); }
		public RobotManagerNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public RobotManagerNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
